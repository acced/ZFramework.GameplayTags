...
namespace GameplayTags.Editor
{
    internal static class GameplayTagCodeGenerator
    {
        ...
        /// <summary>Generate one instance binding per snapshot, never process-static runtime handles.</summary>
        internal static string BuildSource(GameplayTagSettings settings)
        {
            ...
            builder.Append("// <auto-generated> ZFramework Gameplay Tags. Do not edit. </auto-generated>\nnamespace ")
                .Append(string.Join(".", segments)).Append("\n{\n    public sealed class ").Append(className)
                .Append("\n    {\n        public const uint ContentHash = 0x")
                .Append(settings.ComputeContentHash().ToString("X8", CultureInfo.InvariantCulture)).Append("u;\n");
            for (int i = 0; i < names.Count; i++)
            {
                ...
                builder.Append("        public readonly global::GameplayTags.RuntimeTag ").Append(identifier).Append(";\n");
                assignments.Append("            this.").Append(identifier).Append(" = registry.Resolve(\"")
                    .Append(name.Replace("\\", "\\\\").Replace("\"", "\\\"")).Append("\");\n");
            }
            builder.Append("\n        public ").Append(className).Append("(global::GameplayTags.TagRegistry registry)\n        {\n")
                .Append("            if (registry == null) throw new global::System.ArgumentNullException(nameof(registry));\n")
